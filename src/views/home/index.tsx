...
export const HomeView: FC = ({ }) => {
  ...
  const [Imagefile, ImagesetFile] = useState("");
  ...
  const handleFileChange = async (event: any) => {
    ...
    if (browserFile) {
      ImagesetFile(URL.createObjectURL(browserFile));
    }
  };
    ...
    <div className="md:hero mx-auto w-full p-4">
      <div className="md:hero-content flex flex-col">
        <div className="mt-6 ">
          ...
          <div className="token-info md:w-[480px] flex flex-col m-auto">
            ...
            <div className="mt-5 mb-2 uppercase flex font-bold text-2xl">
              Metadatas
            </div>
